...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $query = mysqli_query($con, "update tblposts set PostTitle='$posttitle',postdes='$postdes',postkeywords='$postkeywords',authorname='$authorname',authordes='$authordes',cattags='$cattags',hashtags='$hashtags',CategoryId='$catid',SubCategoryId='$subcatid',PostDetails='$postdetails',PostUrl='$url',Is_Active='$status',lastUpdatedBy='$lastuptdby' where id='$postid'");
        if ($query) {
            $msg = "Post updated ";
        } else {
    ...
    <head>
        ...
        <!-- App title -->
        <title>CURD Operation | Add Post</title>
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <?php
                    $postid = intval($_GET['pid']);
                    $query = mysqli_query($con, "select tblposts.id as postid,tblposts.PostImage,tblposts.PostTitle as title,tblposts.Postdes as des, tblposts.postkeywords as keywords,tblposts.authorname as authname,tblposts.authordes as authdes,tblposts.cattags as cattags,tblposts.hashtags as hashtags,tblposts.PostDetails,tblcategory.CategoryName as category,tblcategory.id as catid,tblsubcategory.SubCategoryId as subcatid,tblsubcategory.Subcategory as subcategory from tblposts left join tblcategory on tblcategory.id=tblposts.CategoryId left join tblsubcategory on tblsubcategory.SubCategoryId=tblposts.SubCategoryId where tblposts.id='$postid' and tblposts.Is_Active=1 ");
                                    ...
                                    <form name="addpost" method="post">
                                        ...
                                        <div class="form-group m-b-20">
                                            ...
                                            <input type="text" class="form-control" id="des"
                                                value="<?php echo htmlentities($row['des']); ?>" name="postdes"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="card-box">
                                                    ...
                                                    <textarea id="example" name="postdescription"
