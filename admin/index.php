...
<head>
    ...
    <meta name="description" content="CURD Operation.">
    <meta name="author" content="CURD Operation">


    <!-- App title -->
    <title>CURD Operation | Admin Panel</title>
                            ...
                            <div class="text-center account-logo-box">
                                <h2 class="text-uppercase">
                                    <a href="index.html" class="text-success">
                                        <span><img src="../images/getinfo4free.png" alt="" height="100"
                                                width="150"></span>
                                    </a>
                                </h2>
