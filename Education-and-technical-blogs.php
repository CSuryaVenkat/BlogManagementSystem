...
<head>
    ...
    <title>Education and Technical Related Blogs</title>
    <meta name="description"
        content="Education and Technical Related Blogs informations and knowledge finds in this page where it is gathered by knowledgeable team members in CurdOperation." />

    <meta name="keywords"
        content="Education related blogs , Technical Related Blogs ,Education and Technical Related Blogs" />
    ...
    <!-- extra lunk -->
    <meta name="apple-mobile-web-app-title" content="Education and Technical Related Blogs" />
                        ...
                        <div class="block-area">
                            <div class="block-title-6">
                                <h4 class="h5 border-primary">
                                    <span class="bg-primary text-white">Latest Education and technical Post</span>
                                </h4>
                            </div>
                            <!--output-->
