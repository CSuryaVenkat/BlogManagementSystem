...
<head>
    ...
    <meta name="description"
        content="Travel and Entertainment Related knowledge and information finds in this where it is gathered by knowledgeable team members in CurdOperation." />

    <meta name="keywords"
        content="Travel blogs ,Entertainment Related knowledge ,Travel and Entertainment Related knowledge ,Travel Related blogs" />
                        ...
                        <div class="block-area">
                            <div class="block-title-6">
                                <h4 class="h5 border-primary">
                                    <span class="bg-primary text-white">Latest Travel and Entertainment Post</span>
                                </h4>
                            </div>
                            <!--output-->
