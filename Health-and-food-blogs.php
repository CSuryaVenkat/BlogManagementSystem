...
<head>
    ...
    <title>Health and Food Related Blogs </title>
    <meta name="description"
        content="Health and Food Related Blogs informations and knowledge finds in this page where it is gathered by knowledgeable team members in CurdOperation." />

    <meta name="keywords"
        content="Health related Blogs , Food Related Blogs , Health and Food Related Blogs , health blogs" />
                        ...
                        <div class="block-area">
                            <div class="block-title-6">
                                <h4 class="h5 border-primary">
                                    <span class="bg-primary text-white">Latest Health and Food Post</span>
                                </h4>
                            </div>
                            <!--output-->
