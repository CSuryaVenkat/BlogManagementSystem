...
<head>
    ...
    <title>How To and troubleshoot Related Information</title>
    <meta name="description"
        content="How to and troubleshoot Related informations and knowledge finds in this where it is gathered by knowledgeable team members in CurdOperation." />

    <meta name="keywords"
        content="How to , how to troubleshoot , troubleshoot Related Information , How To related blogs" />
                        ...
                        <div class="block-area">
                            <div class="block-title-6">
                                <h4 class="h5 border-primary">
                                    <span class="bg-primary text-white">Latest How to and Troubleshoot Post</span>
                                </h4>
                            </div>
                            <!--output-->
