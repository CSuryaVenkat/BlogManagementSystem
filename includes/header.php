      ...
      <nav class="navbar navbar-expand d-lg-none navbar-light px-0">
        <div id="navbar-mobile" class="collapse navbar-collapse nav-top-mobile">
          ...
          <ul id="mobile-menu1" class="navbar-nav">
            <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-1465"
              class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1465 nav-item">
              <a title="About" href="about-us.php" class="nav-link">About us</a>
            </li>
            <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-1466"
              class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1466 nav-item">
  ...
  <div class="mobile-sticky fs-6 bg-secondary">
    <div class="container">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark px-0 py-0">
        ...
        <!--Right Toggle Button-->
        <button class="navbar-toggler px-0" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTogglerDemo2"
        ...
        <div id="navbarTogglerDemo" class="collapse navbar-collapse">
          ...
          <div class="date-area d-none d-lg-block">
            <a title="Home" href="index.php" class="nav-link" id="demo"></a>
            <script defer>const d = new Date();
              document.getElementById("demo").innerHTML = d.toDateString();
            </script>
          </div>
          <!--Top start menu-->
          <ul id="main-menu2" class="navbar-nav">
            <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-1011"
              ...
              <a title="CurdOperation Home" href="index.php" class="nav-link">Home</a>
            </li>
            <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-1012"
              class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1012 nav-item">
              <a title="About Us" href="about-us.php" class="nav-link">About Us</a>
            </li>
            <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-1013"
      ...
      <div class="collapse navbar-collapse col-12 py-2" id="navbarTogglerDemo2">
        ...
        <form class="form-inline" method="get" action="index.php/" role="search">
          <div class="input-group w-100">
            <input class="form-control border border-right-0" name="s" type="text" placeholder="Search &hellip;"
              value="" />
